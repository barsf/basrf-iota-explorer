!function (e, t) { //！表示自执行，而不是一个函数声明
    ...
    var s = function (e, t) {
        ...
        if (!document.getElementsByClassName(n.container).length) {
            ...
            var e = p(), t = P(e, n.input), o = P(e, n.file), r = e.querySelector("." + n.range + " input"), i = e.querySelector("." + n.range + " output"), l = P(e, n.select), s = e.querySelector("." + n.checkbox + " input"), c = P(e, n.textarea);
        ...
        return e
    }), U = W({}, r), K = [], R = void 0, _ = function (e) {
        var t = p();
        for (var i in e)r.hasOwnProperty(i) || "extraParams" === i || console.warn('SweetAlert2: Unknown parameter "' + i + '"');
        t.style.width = "number" == typeof e.width ? e.width + "px" : e.width, t.style.padding = e.padding + "px", t.style.background = e.background,t.style.marginTop = e.marginTop;
        var a = m(), l = v(), s = w(), c = C(), u = k();
        if (a.innerHTML = e.title.split("\n").join("<br>"), e.text || e.html) {
            if ("object" === D(e.html))if (l.innerHTML = "", 0 in e.html)for (var d = 0; d in e.html; d++)l.appendChild(e.html[d].cloneNode(!0)); else l.appendChild(e.html.cloneNode(!0)); else e.html ? l.innerHTML = e.html : e.text && (l.innerHTML = ("" + e.text).split("\n").join("<br>"));
            L(l)
        } else q(l);
        e.showCloseButton ? L(u) : q(u), t.className = n.modal, e.customClass && A(t, e.customClass);
        var b = g(), S = parseInt(null === e.currentProgressStep ? F.getQueueStep() : e.currentProgressStep, 10);
        ...
        return new Promise(function (e, t) {
            ...
            for (var u = function (t) {
                ...
                var n = e || window.event, o = n.target || n.srcElement, i = w(), a = C(), c = i === o || i.contains(o), d = a === o || a.contains(o);
                switch (n.type) {
                    case"mouseover":
                    case"mouseup":
            ...
            var x = function (e, t) {
                ...
                var n = e || window.event, o = n.keyCode || n.which;
                if ([9, 13, 32, 27].indexOf(o) !== -1) {
                    for (var i = n.target || n.srcElement, a = S(r.focusCancel), l = -1, s = 0; s < a.length; s++)if (i === a[s]) {
                        l = s;
                        break
                    }
            ...
            c.previousWindowKeyDown = window.onkeydown, window.onkeydown = M, r.buttonsStyling && (v.style.borderLeftColor = r.confirmButtonColor, v.style.borderRightColor = r.confirmButtonColor), F.showLoading = F.enableLoading = function () {
                ...
                var e = o();
                if (!e)return !1;
                if ("radio" === e.type)for (var t = e.parentNode.parentNode, n = t.querySelectorAll("input"), r = 0; r < n.length; r++)n[r].disabled = !1; else e.disabled = !1
            }, F.disableInput = function () {
                var e = o();
                if (!e)return !1;
                if (e && "radio" === e.type)for (var t = e.parentNode.parentNode, n = t.querySelectorAll("input"), r = 0; r < n.length; r++)n[r].disabled = !0; else e.disabled = !0
            }, F.recalculateHeight = I(function () {
                var e = p(), t = e.style.display;
            ...
            for (var V = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], O = void 0, N = 0; N < V.length; N++) {
                var j = n[V[N]], W = P(i, j);
                if (O = o(V[N])) {
                    for (var U in O.attributes)if (O.attributes.hasOwnProperty(U)) {
            ...
            !function () {
                switch (r.input) {
                    ...
                    case"file":
                        ...
                        break;
                    case"range":
                        var e = P(i, n.range), t = e.querySelector("input"), a = e.querySelector("output");
                    ...
                    case"radio":
                        ...
                        c.innerHTML = "", Y = function (e) {
                            for (var t in e) {
                                var o = 1, i = document.createElement("input"), a = document.createElement("label"), l = document.createElement("span");
                        ...
                        break;
                    case"checkbox":
                        var u = P(i, n.checkbox), d = o("checkbox");
